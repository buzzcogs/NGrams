...
public class NGramCalculator3 
{
    ...
    public NGramCalculator3(String fname, int degree)
    {
    ...
    public static void main(String[] args)             
    {
        ...
        try 
        {
            ...
            myNGramCalc = new NGramCalculator3(fileName, ngramdegree);
